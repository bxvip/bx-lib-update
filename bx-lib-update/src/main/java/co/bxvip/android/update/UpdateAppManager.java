...
import co.bxvip.android.update.listener.ExceptionHandler;
import co.bxvip.android.update.listener.ExceptionHandlerHelper;
import co.bxvip.android.update.listener.IUpdateDialogFragmentListener;
import co.bxvip.android.update.service.DownloadService;
import co.bxvip.android.update.utils.AppUpdateUtils;
...
//                || !mTargetPath.startsWith(preSuffix)
     ...
     * @param callback
     */
    private void processData(String result, final @NonNull UpdateCallback callback) {
        try {
